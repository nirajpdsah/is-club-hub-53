...
export default function Footer() {
  return (
    <footer className="bg-isclub-dark text-white py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#focus-areas" className="text-gray-400 hover:text-white transition-colors">Focus Areas</a>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="space-y-3">
              ...
              <button
                type="submit"
                className={cn(
                  "w-full px-4 py-3 rounded-lg bg-isclub-blue text-white font-medium",
                  "transition-all hover:bg-isclub-blue/90"
                )}
              >
                Subscribe
              </button>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} IS Club. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

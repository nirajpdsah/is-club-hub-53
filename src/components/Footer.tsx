        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-isclub-teal transition-colors">
          ...
          <div>
            ...
            <form className="space-y-3">
              <div>
                <input
                  ...
                  className={cn(
                    ...
                    "focus:ring-2 focus:ring-isclub-teal focus:border-isclub-teal",
              ...
              <button
                type="submit"
                className={cn(
                  "w-full px-4 py-3 rounded-lg bg-isclub-teal text-white font-medium",
                  "transition-all hover:bg-isclub-teal/90"
                )}
              >
                Subscribe
              </button>
